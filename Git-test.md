...
git checkout branch_name используется для переключения веток и выгрузки их содержимого в рабочую директорию.
...
## Проблема вызвать конфликт

при попытке вызвать конфликт при слиянии веток, все автоматически оставляет и одно, и другое.
создавал разные ветки,   писал и переписывал, все равно автоматом оставляет оба варианта.
